    ...
    <header class="header-principal">
            ...
            <div class="cards-content-curso">
                ...
                <div  v-for="curso in cursosRecent " class="card-curso">
                    ...
                    <div class="card-curso-body">
                        <div class="date-published">{{getDateHuman(curso.dateModificacion)}} <span><i class="fas fa-calendar"></i></span></div>
                        <h3>{{curso.nombre}}</h3>
        ...
        <section class="team">
          ...
          <div class="content-team-card">
            <div class="team-card">
                <img class="team-thumb" src="./src/img/perfilUsers/alfredo.jpg" alt="">
                  <p class="team-position">Diseñador</p>
                  <h4 class="team-employee">Alfredo Hernández Pérez</h4>
            </div>

            <div class="team-card">
                  <img  class="team-thumb" src="./src/img/perfilUsers/marce.jpg" alt="">
                  <p class="team-position">DBA</p>
            ...
            <div class="team-card">
                  ...
                  <p class="team-position">Programador</p>
                  <h4 class="team-employee">Efrain Vicencio Rivera</h4>
            </div>
          </div>
